...
<Modal title="이 놀이는?" {onclose}>
	...
	<h3>힌트 · 포기</h3>
	<ul>
		<li><b>힌트</b>: 노란색으로 나온 자모 하나가 실제로 몇 번째 칸인지 알려줍니다. 한 판에 한 번. 슈퍼겁쟁이용.</li>
		<li><b>포기</b>: 두 번 누르면 정답을 공개하고 패배로 기록합니다.</li>
		<li>등반 모드는 끝나면 그동안 맞힌 정답을 피라미드로 쌓아 보여줍니다.</li>
	</ul>

	<h3>하드모드</h3>
	<p>설정에서 켜면 지금까지 받은 힌트를 반드시 다시 써야 합니다. 모든 모드에 적용됩니다.</p>
	<ul>
		<li><span class="dot c"></span> 초록 자모는 <b>같은 자리</b>에 그대로 둡니다.</li>
