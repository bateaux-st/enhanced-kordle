...
import { answerCount } from '$lib/server/dict';
...
export const POST: RequestHandler = async ({ request }) => {
	...
	if (!body || (body.source !== 'daily' && body.source !== 'random')) error(400, 'bad request');
